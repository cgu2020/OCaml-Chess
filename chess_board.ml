...
let is_checkmate b =
  if in_check Tile.White then
    ...
    let whites_attacking_squares =
      fst (attackers_without_king 0 b [] [])
    in
    ...
    then false
      ...
      not (List.mem a whites_attacking_squares)
    ...
    then false
      ...
      not (List.mem a blacks_attacking_squares)
  else false
